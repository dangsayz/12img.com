...
export default function AdminSettingsPage() {
  return (
    <div className="space-y-8 max-w-[1400px]">
      <div>
        <h1 className="font-serif text-3xl lg:text-4xl text-[#141414]">Settings</h1>
        <p className="text-[#525252] mt-2">Configure system settings and preferences</p>
      </div>
      ...
      <div className="bg-white border border-[#E5E5E5] p-16">
        <div className="text-center">
          <div className="w-16 h-16 border border-[#E5E5E5] flex items-center justify-center mx-auto mb-6">
            <Settings className="w-8 h-8 text-[#525252]" />
          </div>
