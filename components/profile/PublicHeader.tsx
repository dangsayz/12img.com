...
export function PublicHeader({ showProfiles = true }: PublicHeaderProps) {
                ...
                {isLoaded && isSignedIn ? (
                  ...
                  <>
                    <button 
                      ...
                      className="w-full px-4 py-3 rounded-xl text-stone-600 hover:bg-stone-50 transition-all text-left font-medium"
                    >
                      Log in
                    </button>
                    <button 
                      onClick={() => { setMobileMenuOpen(false); openAuthModal('sign-up') }}
                      className="w-full px-4 py-3 rounded-xl bg-stone-900 text-white hover:bg-stone-800 transition-all text-center font-medium mt-1"
                    >
                      Start free
                    </button>
                  </>
