...
export const FEATURE_ROWS: FeatureRow[] = [
  // ─── Storage & Limits ───
  {
    ...
    availability: {
      free: { status: 'included', note: '5GB', tooltip: 'Approx. 3,000 photos' },
      essential: { status: 'included', note: '20GB', tooltip: 'Approx. 8,000 photos' },
      pro: { status: 'included', note: '100GB', tooltip: 'Approx. 40,000 photos' },
      studio: { status: 'included', note: '500GB', tooltip: 'Approx. 200,000 photos' },
      elite: { status: 'included', note: '2TB', tooltip: 'Approx. 800,000 photos' },
    },
  },
  {
    id: 'gallery_limit',
    ...
    availability: {
      free: { status: 'limited', note: '5 galleries' },
  ...
  // ─── Client Management ───
  {
    ...
    availability: {
      ...
      essential: { status: 'limited', note: '3/month' },
  ...
  },
  {
    ...
    availability: {
      free: { status: 'included', tooltip: 'Try the full client experience' },
      essential: { status: 'included' },
      pro: { status: 'included' },
      studio: { status: 'included' },
      elite: { status: 'included' },
