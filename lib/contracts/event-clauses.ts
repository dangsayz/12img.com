...
const UNIVERSAL_CLAUSES: ClauseTemplate[] = [
  {
    ...
    title: 'Payment Terms',
    category: 'payment',
    content: `A non-refundable retainer of {{retainer_amount}} of the total package price ({{package_price_formatted}}) is due upon signing this agreement to secure the date. The remaining balance is due {{payment_due_date}}.
